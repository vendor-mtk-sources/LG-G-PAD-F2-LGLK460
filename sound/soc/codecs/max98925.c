...
static void max98925_amp_reinit_put_work(struct work_struct *work)
{
	...
	regmap_read(max98925->regmap, MAX98925_R038_GLOBAL_ENABLE, &backup_reg);
	msg_maxim("Reinit work in, sel : %d backup_register=0x%x\n", sel, backup_reg);
...
/* DAI format configuration */
	...
	max98925_regmap_write(max98925, MAX98925_R038_GLOBAL_ENABLE, backup_reg);
