...
struct ft5526_test_off {
	u16 offset0;
	u16 offset1;
} __packed;

struct ft5526_test_off_info {
	struct ft5526_test_off m1_m2_raw;
	struct ft5526_test_off frame0_1;
	struct ft5526_test_off frame2_short;
	struct ft5526_test_off os_result;
} __packed;
