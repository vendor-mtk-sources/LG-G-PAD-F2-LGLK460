...
unsigned int bright_arr_pwm[]={
	12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 13, 13, 14, 14, 15, 15, 16, 17,                    // 19
	17, 18, 18, 19, 19, 20, 20, 21, 22, 22, 23, 23, 24, 24, 25, 26, 26, 27, 27, 28,                    // 39
	28, 29, 29, 30, 31, 31, 32, 32, 33, 33, 34, 34, 35, 36, 36, 37, 37, 38, 38, 39,                    // 59
	40, 42, 44, 46, 48, 50, 52, 54, 56, 58, 60, 62, 65, 67, 69, 71, 73, 75, 77, 79,                    // 79
	81, 83, 85, 87, 90, 92, 94, 96, 98, 100, 102, 104, 106, 108, 110, 112, 115, 117, 119, 121,                    // 99
	123, 125, 127, 129, 131, 133, 135, 137, 140, 143, 147, 151, 155, 158, 162, 166, 170, 173, 177, 181,                    // 119
	185, 189, 192, 196, 200, 204, 207, 211, 215, 219, 222, 226, 230, 234, 238, 241, 245, 249, 253, 256,                    // 139
	260, 264, 268, 271, 275, 279, 283, 287, 290, 294, 298, 302, 305, 309, 313, 317, 321, 321, 325, 330,                    // 159
	335, 340, 345, 350, 355, 360, 365, 370, 375, 380, 385, 391, 398, 405, 411, 418, 425, 431, 438, 445,                    // 179
	451, 458, 465, 471, 478, 485, 491, 498, 505, 511, 518, 525, 531, 538, 545, 551, 558, 565, 571, 578,                    // 199
	585, 591, 598, 605, 611, 618, 625, 633, 641, 649, 657, 665, 673, 681, 689, 698, 706, 714, 722, 730,                    // 219
	738, 746, 754, 763, 771, 779, 787, 795, 803, 811, 819, 828, 836, 844, 852, 860, 868, 876, 884, 893,                    // 239
	901, 909, 917, 925, 933, 941, 949, 958, 966, 974, 982, 990, 998, 1006, 1014, 1023,                    // 255
};
#endif
...
static int disp_pwm_level_remap(disp_pwm_id_t id, int level_1024)
{
	...
	if(level_1024 == 0)
	    ...
	    current_brightness = bright_arr_pwm[level_1024];
	printk("[Brightness] level_1024 = %d, current_brightness = %d\n", level_1024, current_brightness);
	return current_brightness;
#elif defined(TOVIS_INCELL_TD4100_HD_LV7_SPR)
	if (level_1024 > 1017)
		level_1024 = 1017;
	return level_1024;
#else
