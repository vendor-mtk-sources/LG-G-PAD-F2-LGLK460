...
/*LGE_CHANGE_S, 2017-06-16, fixed wbt issue, soojong.jin@lge.com*/
            if(ptempbuf == NULL){
                pr_err("[HI556_OTP] ptempbuf is NULL, Nothing to do from here\n");
                return -EFAULT;
            }
/*LGE_CHANGE_E, 2017-06-16, fixed wbt issue, soojong.jin@lge.com*/
#ifdef EEPROMGETDLT_DEBUG
