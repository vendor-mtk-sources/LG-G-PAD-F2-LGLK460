...
PowerUp PowerOnList = {
	{
	 ...
	 {SENSOR_DRVNAME_HI556_MIPI_RAW_QT_MAIN,
	  {
	   {PDN, Vol_Low, 5},
	   {RST, Vol_Low, 5},
	   {DOVDD, Vol_1800, 1},
	...
	{SENSOR_DRVNAME_HI556_MIPI_RAW_QT_SUB,
	  {
	   {PDN, Vol_Low, 5},
	   {RST, Vol_Low, 5},
	   {DOVDD, Vol_1800, 1},
	...
	{SENSOR_DRVNAME_HI556_MIPI_RAW_QH_MAIN,
	  {
	   {PDN, Vol_Low, 5},
	   {RST, Vol_Low, 5},
	   {DOVDD, Vol_1800, 1},
	...
	{SENSOR_DRVNAME_HI556_MIPI_RAW_QH_SUB,
	  {
	   {PDN, Vol_Low, 5},
	   {RST, Vol_Low, 5},
	   {DOVDD, Vol_1800, 1},
...
{
	int ret = 0;
#if !defined(CONFIG_MACH_MT6750_TH8)  //PHB modified for reduce boot time
	has_mipi_switch = 1;
#endif
...
#endif   //PHB modified for reduce boot time
