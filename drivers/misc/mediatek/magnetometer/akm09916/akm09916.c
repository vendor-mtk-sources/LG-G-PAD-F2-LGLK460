...
#define AKM09916_DEFAULT_DELAY	20
...
struct mag_hw mag_cust_A;
static struct mag_hw *hw = &mag_cust_A;
...
static long AKECS_SetMode_FUSEAccess(void)
{
	...
	/* Set measure mode */
	buffer[0] = AK09916_REG_CNTL2;
	buffer[1] = AK09916_MODE_FUSE_ACCESS;
	/* Set data */
#endif
	return AKI2C_TxData(buffer, 2);
}
...
int FST_AK09916(void)
{
	...
	TEST_DATA(TLIMIT_NO_RST_WIA1_09916, TLIMIT_TN_RST_WIA1_09916, (int)i2cData[0], TLIMIT_LO_RST_WIA1_09916,
		  TLIMIT_HI_RST_WIA1_09916, &pf_total);
	TEST_DATA(TLIMIT_NO_RST_WIA2_09916, TLIMIT_TN_RST_WIA2_09916, (int)i2cData[1], TLIMIT_LO_RST_WIA2_09916,
		  TLIMIT_HI_RST_WIA2_09916, &pf_total);


	if (AKECS_SetMode(AK09916_MODE_FUSE_ACCESS) < 0) {
		MAGN_LOG("%s:%d Error.\n", __func__, __LINE__);
		return 0;
	}

	i2cData[0] = AK09916_REG_CNTL2;
	if (AKI2C_RxData(i2cData, 1) < 0) {
		MAGN_LOG("%s:%d Error.\n", __func__, __LINE__);
		return 0;
	}
	TEST_DATA(TLIMIT_NO_WR_CNTL2_09916, TLIMIT_TN_WR_CNTL2_09916, (int)i2cData[0], TLIMIT_LO_WR_CNTL2_09916,
		  TLIMIT_HI_WR_CNTL2_09916, &pf_total);

	i2cData[0] = AK09916_FUSE_ASAX;
	if (AKI2C_RxData(i2cData, 3) < 0) {
		MAGN_LOG("%s:%d Error.\n", __func__, __LINE__);
		return 0;
	}
	...
	TEST_DATA(TLIMIT_NO_ASAX_09916, TLIMIT_TN_ASAX_09916, asax, TLIMIT_LO_ASAX_09916, TLIMIT_HI_ASAX_09916,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_ASAY_09916, TLIMIT_TN_ASAY_09916, asay, TLIMIT_LO_ASAY_09916, TLIMIT_HI_ASAY_09916,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_ASAZ_09916, TLIMIT_TN_ASAZ_09916, asaz, TLIMIT_LO_ASAZ_09916, TLIMIT_HI_ASAZ_09916,
		  &pf_total);
	...
	i2cData[0] &= 0x7F;
	TEST_DATA(TLIMIT_NO_SNG_ST1_09916, TLIMIT_TN_SNG_ST1_09916, (int)i2cData[0], TLIMIT_LO_SNG_ST1_09916,
	...
	TEST_DATA(TLIMIT_NO_SNG_ST2_09916, TLIMIT_TN_SNG_ST2_09916, (int)i2cData[8], TLIMIT_LO_SNG_ST2_09916,
		  TLIMIT_HI_SNG_ST2_09916, &pf_total);
	...
	i2cData[0] &= 0x7F;
	TEST_DATA(TLIMIT_NO_SLF_ST1_09916, TLIMIT_TN_SLF_ST1_09916, (int)i2cData[0], TLIMIT_LO_SLF_ST1_09916,
	...
	TEST_DATA(TLIMIT_NO_SLF_RVHX_09916,
		  ...
		  (hdata[0]) * ((asax - 128) / 256 + 1), TLIMIT_LO_SLF_RVHX_09916, TLIMIT_HI_SLF_RVHX_09916, &pf_total);

	TEST_DATA(TLIMIT_NO_SLF_RVHY_09916,
		  TLIMIT_TN_SLF_RVHY_09916,
		  (hdata[1]) * ((asay - 128) / 256 + 1), TLIMIT_LO_SLF_RVHY_09916, TLIMIT_HI_SLF_RVHY_09916, &pf_total);

	TEST_DATA(TLIMIT_NO_SLF_RVHZ_09916,
		  TLIMIT_TN_SLF_RVHZ_09916,
		  (hdata[2]) * ((asaz - 128) / 256 + 1), TLIMIT_LO_SLF_RVHZ_09916, TLIMIT_HI_SLF_RVHZ_09916, &pf_total);
...
#else
		ret = AKECS_SetMode(AK09916_MODE_FUSE_ACCESS);
#endif
		if (ret < 0)
			return ret;
#ifdef AKM_Device_AK8963
...
#else
		sense_conf[0] = AK09916_FUSE_ASAX;
#endif
...
#else
		ret = AKECS_SetMode(AK09916_MODE_POWERDOWN);
#endif
		if (ret < 0)
			return ret;
...
{
	struct akm09916_i2c_data *obj = container_of(h, struct akm09916_i2c_data, early_drv);
	int err = 0;
...
static int akm09916_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	{
		client->addr = 0x0c;
		printk("i2c_client_afx133->addr=%d\n",client->addr);
	}
	data->client = client;
