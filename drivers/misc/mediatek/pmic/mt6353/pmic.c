...
{
	pr_err("[pre][0] Reg[0x%x]=0x%x\n",
		MT6353_WDTDBG_CON0, upmu_get_reg_value(MT6353_WDTDBG_CON0));
	pr_err("[pre][1] Reg[0x%x]=0x%x\n",
		MT6353_WDTDBG_CON1, upmu_get_reg_value(MT6353_WDTDBG_CON1));
	pr_err("[pre][2] Reg[0x%x]=0x%x\n",
		MT6353_WDTDBG_CON2, upmu_get_reg_value(MT6353_WDTDBG_CON2));
	pr_err("[pre][3] Reg[0x%x]=0x%x\n",
		MT6353_WDTDBG_CON3, upmu_get_reg_value(MT6353_WDTDBG_CON3));

	pmic_config_interface(MT6353_WDTDBG_CON0, 1, 0x1, 0);
	pmic_config_interface(MT6353_WDTDBG_CON0, 0, 0x1, 0);
...
{
	pr_err("[post][0] Reg[0x%x]=0x%x\n",
		MT6353_BUCK_VCORE_VOL_CON0, upmu_get_reg_value(MT6353_BUCK_VCORE_VOL_CON0));
	pr_err("[post][0] Reg[0x%x]=0x%x\n",
		MT6353_BUCK_VCORE2_VOL_CON0, upmu_get_reg_value(MT6353_BUCK_VCORE2_VOL_CON0));
	pr_err("[post][1] Reg[0x%x]=0x%x\n",
		MT6353_BUCK_VPROC_VOL_CON0, upmu_get_reg_value(MT6353_BUCK_VPROC_VOL_CON0));
	pr_err("[post][2] Reg[0x%x]=0x%x\n",
		MT6353_BUCK_VS1_VOL_CON0, upmu_get_reg_value(MT6353_BUCK_VS1_VOL_CON0));
	pr_err("[post][3] Reg[0x%x]=0x%x\n",
		MT6353_LDO_VSRAM_PROC_VOL_CON0, upmu_get_reg_value(MT6353_LDO_VSRAM_PROC_VOL_CON0));
