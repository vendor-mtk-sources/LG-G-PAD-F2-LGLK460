...
TARGET_KERNEL_COMPRESSION_TOOL=lz4demo
...
$(KERNEL_ZIMAGE_OUT): $(KERNEL_HEADERS_TIMESTAMP) FORCE | $(KERNEL_OUT) $(LZ4DEMO)
...
ifneq ($(SUPPORT_EXFAT_TUXERA), )
	...
	@sh tuxera_update.sh --target target/lg.d/mobile-$(TARGET_BOARD_PLATFORM) --use-cache --latest --max-cache-entries 2 --source-dir $(ANDROID_BUILD_TOP)/kernel-3.18 --output-dir $(KERNEL_OUT) $(SUPPORT_EXFAT_TUXERA)
